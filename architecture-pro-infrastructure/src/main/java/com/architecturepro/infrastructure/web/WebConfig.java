...
public class WebConfig implements WebMvcConfigurer {
    ...
    public WebConfig(SecurityProperties securityProperties, ArchitectureProProperties architectureProProperties) {
    ...
    public void configurePathMatch(org.springframework.web.servlet.config.annotation.PathMatchConfigurer configurer) {
        String normalizedPrefix = normalizePrefix(architectureProProperties.getApiPrefix());
        if (!StringUtils.hasText(normalizedPrefix)) {
            return;
        }
        configurer.addPathPrefix(
                normalizedPrefix,
                HandlerTypePredicate.forBasePackage("com.architecturepro")
